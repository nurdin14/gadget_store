...
<head>
  ...
  <title>Celluer Phone | Pelanggan</title>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="index.php?page=all_produk" class="nav-link">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="index.php?page=oppo" class="nav-link">
                  <i class="far fa-circle nav-icon" style="color: #F79F1F;"></i>
                  <p>Oppo</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="index.php?page=vivo" class="nav-link">
                  <i class="far fa-circle  nav-icon" style="color: #F79F1F;"></i>
                  <p>Vivo</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="index.php?page=samsung" class="nav-link">
                  <i class="far fa-circle  nav-icon" style="color: #F79F1F;"></i>
                  <p>Samsung</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="index.php?page=xiaomi" class="nav-link">
                  <i class="far fa-circle  nav-icon" style="color: #F79F1F;"></i>
                  <p>Xiaomi</p>
                </a>
              </li>
