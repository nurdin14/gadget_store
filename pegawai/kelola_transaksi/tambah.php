        ...
        <div class="card-body">
            <form action="" method="post">
                ...
                <div class="form-group row">
                    ...
                    <a href="index.php?page=kelola_transaksi" class="btn" style="background-color:#e84118; color:white;">Cancel</a>
                    </div>
                </div>
            </form>
        </div>
    ...
    if(isset($_POST['simpan']))
    {
        ...
        if($query)
        {
            echo "<script>
                    ...
                    window.location='index.php?page=kelola_transaksi'
                  </script>";
        } else {
            echo "<script>
            alert('Data Gagal Dimasukan');
            window.location='index.php?page=tambah_transaksi'
          </script>";
        }
    } 
?>    